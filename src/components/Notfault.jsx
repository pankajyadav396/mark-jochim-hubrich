...
const Notfault = () => {
    return (
        <>
            ...
            <p data-aos="fade-up" className='color-black fw-800 ff-neue text-center mt-5'>How would you know when you are busy with completely different things at the moment:</p>
