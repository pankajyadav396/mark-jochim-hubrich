    ...
    return (
        <>
            <div className='container max-w-1140 mt-md-5 pt-md-5 position-relative z-1'>
                <div className='row pt-md-5 justify-content-center justify-content-md-start align-items-center'>
            ...
            <p data-aos="fade-up" className='color-black fw-800 ff-neue text-center mt-5 text-capitalize'>How would you know when you are busy with completely different things at the moment:</p>
