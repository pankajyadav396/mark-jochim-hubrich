...
const Selfesteem = () => {
    ...
    return (
        <>
            <div className=' bg-self px-3 py-4 py-md-0' >
                <div className='container max-w-1000'>
                    <div className='row justify-content-lg-end justify-content-center'>
                        <div className=' col-lg-9 col-12'>
                            <div className='row justify-content-center'>
                                <div className='col-md-4 col-sm-6 d-flex d-sm-block justify-content-center align-items-center box-self'>
                    ...
                    <div className='row mt-4 justify-content-center justify-content-lg-start pt-2'>
                        <div className='col-lg-9 col-12'>
                            <div className='row justify-content-center'>
                                <div className='col-md-4 col-sm-6 d-flex d-sm-block justify-content-center align-items-center box-self2'>
            ...
            <p className=' ff-poppins color-black pb-1 fw-normal text-center mt-5'>You are not alone! Numerous women before you stood exactly at this point, where you are now.</p>
            <a href='#' className='  cursor-pointer d-flex align-items-center max-w-432 mx-auto color-gradient ff-inter fs-sm lh-24 fw-medium btn-head'><span><img src={imgmessage} alt="img" className=' max-w-50' /></span><p className="m-0">Book a non-binding initial consultation now</p></a>
        </>
    )
}
