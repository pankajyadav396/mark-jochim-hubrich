            ...
            <div className=' max-w-1140 container p-0 flex-grow-1 d-flex align-items-center justify-content-center position-relative'>
                ...
                <div className=' row w-100 h-90vh'>
                    <div className='col-lg-6 col-12'>
                        <p className=' color-orange fs-sm1 ff-neue fw-bold mb-0'>Marc joachim hubrich</p>
                        <h1 className='color-black fs-xl letter-spacing ff-neue1 lh-77 fw-300'>Now I let you
                        ...
                        <div className=' d-flex mt-4'>
                            <div className=' cursor-pointer d-flex align-items-center color-gradient ff-inter fs-sm lh-24 fw-medium btn-head'><span><img src={imgmessage} alt="img" className=' max-w-50' /></span><p className="m-0">Book a non-binding initial consultation now</p></div>
                            <img src={call} className='ms-3 cursor-pointer' alt="call" />
                        </div>
                    </div>
                    <div className='col-lg-6 col-12'>
