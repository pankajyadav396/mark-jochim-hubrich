                ...
                <div className='h-100 container-lg max-w-1140 justify-content-between d-flex align-items-center'>
                    ...
                    <div className='d-flex gap-4 align-items-center'>
                        <ul className={`${nav ? "open" : "not-open"
                            ...
                            <li><a onClick={show} href="#home" className='home fs-sm fw-normal ff-neue  lh-24 text-decoration-none list-unstyled'>Benefits</a></li>
                            <li><a onClick={show} href="#aboutus" className='home fs-sm fw-normal ff-neue lh-24 text-decoration-none list-unstyled'>Testimonials</a></li>
